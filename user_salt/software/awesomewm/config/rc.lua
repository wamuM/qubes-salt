...
-- SPDX-FileCopyrightText: 2025 Marcel M. T. <contact@wamu-m.com>
...
--- client
    awful.key({ modkey,           }, "h",
        ...
        {description = "focus the client to the left", group = "client"}
    ),
    awful.key({ modkey,           }, "j",
        function ()
            awful.client.focus.bydirection("down")
        end,
        {description = "focus the client above", group = "client"}
    ),
    awful.key({ modkey,           }, "k",
        function ()
            awful.client.focus.bydirection("up")
        end,
        {description = "focus the client bellow", group = "client"}
    ),
    awful.key({ modkey,           }, "l",
        function ()
            awful.client.focus.bydirection("right")
        end,
        {description = "focus the client to the right", group = "client"}
    ),
    ...
    awful.key({ modkey, "Control"   }, "j", function () awful.client.swap.bydirection("bottom")    end,
              {description = "swap with the client bellow", group = "client"}),

    awful.key({ modkey, "Control"   }, "k", function () awful.client.swap.bydirection("top")    end,
...
-- layout
    ...
    awful.key({ modkey, "Mod4"   }, "space", function () awful.layout.inc(-1)                end,
...
for i = 1, 10 do
    globalkeys = gears.table.join(globalkeys,
        ...
        awful.key({ modkey, "Control", "Shift" }, "#" .. i + 9,
                  ...
                  {description = "move focused client to tag #"..i.."and follow", group = "tag"}),
...
awful.rules.rules = {
    ...
    -- Set KeePassXC to always map on the tag named "10" on screen 1.
